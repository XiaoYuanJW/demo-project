...
@TableName(value ="sms_review_comment_reply")
@ApiModel(value = "SmsReviewCommentReply", description = "")
public class SmsReviewCommentReply extends BaseEntity {
    @NotNull(message = "[商品点评评论回复]不能为空")
    @TableId(value = "id", type = IdType.AUTO)
    @ApiModelProperty(value = "商品点评评论回复")
    private Long id;
    ...
    @NotNull(message = "[商铺点评评论回复人id]不能为空")
    @ApiModelProperty(value = "商铺点评评论回复人id")
    ...
    @ApiModelProperty(value = "评论回复回复用户id")
    private Long replyToMemberId;
    
    @ApiModelProperty(value = "评论回复回复id")
